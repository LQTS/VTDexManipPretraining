...
@dataclass
class ViTacTrackConfig(TrackingConfig):
    # Weights & Biases Setup
    project: str = "ViTacMani"
    ...
    notes: str = "ViTac Tracking Notes"

# Create a configuration group `trackers` and populate with the above...
cs = ConfigStore.instance()

cs.store(group="tracking", name="vitac-track", node=ViTacTrackConfig)
